package com.backend.FileBridge.security;
...
public class ClerkJwtAuthFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain) throws ServletException, IOException {
        ...
        // after testing file routes in post replace /files with /files/public
        if(request.getRequestURI().contains("/webhooks") || request.getRequestURI().contains("/files/public") || request.getRequestURI().contains("/files/download")){
